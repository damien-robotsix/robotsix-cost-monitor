...
- [Configuration Reference](reference/configuration.md) — configuration options
  and defaults.
- [CLI Reference](reference/cli.md) — command-line interface usage and options.
- [Project README](https://github.com/damien-robotsix/robotsix-cost-monitor#readme) —
  setup, features, CLI usage, and development instructions.
